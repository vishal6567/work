...
router.post('/reportDetail', function (req, res, next) {
...
router.delete('/reportDetailDelete/:id', function (req, res, next) {
...
router.get('/reportDetailId/:id', function (req, res, next) {
	db.getConnection(function (error, conn) {
...
router.put('/updateReportDetail/:id',function (req, res, next) {
	console.log("body" + (JSON.stringify(req.body)));
	db.getConnection(function (error, conn) {																																																																			
